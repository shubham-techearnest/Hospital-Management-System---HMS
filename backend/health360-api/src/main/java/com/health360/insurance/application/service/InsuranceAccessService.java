...
public class InsuranceAccessService {
    ...
    public void assertModuleEnabled(UserPrincipal principal, UUID hospitalId, UUID branchId) {
        ...
        featureAccessService.assertHasFeature(
                ...
                PlanFeatureKeys.FEATURE_INSURANCE,
                "Insurance / TPA is not included in this hospital's subscription plan");
    }

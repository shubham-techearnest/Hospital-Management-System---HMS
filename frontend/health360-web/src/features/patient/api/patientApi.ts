...
export async function updateAllergy(id: string, payload: Omit<Allergy, 'id'>) {
  const { data } = await apiClient.put<ApiEnvelope<Allergy>>(
    `/patients/me/profile/allergies/${id}`,
    payload,
  );
  return data.data;
}
...
export async function updateMedication(id: string, payload: Omit<Medication, 'id'>) {
  const { data } = await apiClient.put<ApiEnvelope<Medication>>(
    `/patients/me/profile/medications/${id}`,
    payload,
  );
  return data.data;
}
...
export async function updateSurgery(id: string, payload: Omit<Surgery, 'id'>) {
  const { data } = await apiClient.put<ApiEnvelope<Surgery>>(
    `/patients/me/profile/surgeries/${id}`,
    payload,
  );
  return data.data;
}
...
export async function updateChronicCondition(id: string, payload: Omit<ChronicCondition, 'id'>) {
  const { data } = await apiClient.put<ApiEnvelope<ChronicCondition>>(
    `/patients/me/profile/chronic-conditions/${id}`,
    payload,
  );
  return data.data;
}
...
export async function updateEmergencyContact(id: string, payload: Omit<EmergencyContact, 'id'>) {
  const { data } = await apiClient.put<ApiEnvelope<EmergencyContact>>(
    `/patients/me/profile/emergency-contacts/${id}`,
    payload,
  );
  return data.data;
}

...
import {
  ...
  FormControlLabel, IconButton, List, ListItem, ListItemText, Skeleton, Stack, TextField,
} from '@mui/material';
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            ...
            <TextField label="Gender" fullWidth value={form.gender} onChange={(e) => setForm({ ...form, gender: e.target.value })} />

...
export async function listMySchedules(): Promise<DoctorSchedule[]> {
  const { data } = await apiClient.get<ApiEnvelope<DoctorSchedule[]>>('/scheduling/doctors/me/schedules');
  return data.data ?? [];
}

export async function createSchedule(payload: CreateSchedulePayload): Promise<DoctorSchedule> {
  const { data } = await apiClient.post<ApiEnvelope<DoctorSchedule>>('/scheduling/doctors/me/schedules', payload);
  return data.data!;
}

export async function updateSchedule(scheduleId: string, payload: CreateSchedulePayload): Promise<DoctorSchedule> {
...
export async function getDoctorBookingLocations(doctorId: string): Promise<DoctorBookingLocation[]> {
...
export async function bookAppointment(payload: BookAppointmentPayload): Promise<AppointmentBooking> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentBooking>>('/scheduling/appointments', payload);
  return data.data!;
}

export async function listMyAppointments(filter: AppointmentFilter = 'all', page = 0, size = 20): Promise<AppointmentSummary[]> {
...
export async function getMyAppointment(appointmentId: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.get<ApiEnvelope<AppointmentDetail>>(`/scheduling/appointments/${appointmentId}`);
  return data.data!;
}

export async function cancelMyAppointment(appointmentId: string, reason?: string): Promise<AppointmentDetail> {
...
export async function rescheduleMyAppointment(appointmentId: string, newSlotId: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function listDoctorAppointments(filter: AppointmentFilter = 'all'): Promise<AppointmentSummary[]> {
...
export async function getDoctorAppointment(appointmentId: string): Promise<AppointmentDetail> {
...
export async function cancelDoctorAppointment(appointmentId: string, reason?: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function confirmDoctorAppointment(appointmentId: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function requestDoctorReschedule(appointmentId: string, message?: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function postponeDoctorAppointment(appointmentId: string, message?: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function resumeDoctorAppointment(appointmentId: string): Promise<AppointmentDetail> {
  const { data } = await apiClient.post<ApiEnvelope<AppointmentDetail>>(
...
export async function blockScheduleSlots(scheduleId: string, payload: BlockSchedulePayload): Promise<SlotBlockResult> {
...
export async function unblockScheduleSlots(scheduleId: string, payload: BlockSchedulePayload): Promise<SlotBlockResult> {
  const { data } = await apiClient.post<ApiEnvelope<SlotBlockResult>>(
